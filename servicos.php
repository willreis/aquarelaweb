...
<!-- Mirrored from axilthemes.com/demo/template/keystroke/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jan 2021 19:28:27 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="axil-scroll-navigation-area axil-scroll-navigation position-relative bg-color-white">
                ...
                <nav class="axil-scroll-nav navbar navbar-example2">
                    <ul class="nav nav-pills justify-content-center sidebar__inner">
                        ...
                        <li class="nav-item"><a class="nav-link smoth-animation" href="#section3">Online marketing</a>
                        </li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-title text-left">
                                    <span class="sub-title extra04-color wow" data-splitting>services</span>
                                    <h2 class="title wow" data-splitting>Online marketing</h2>
                                </div>
                            </div>
                        </div>
                        <!-- Start Service Wrapper  -->
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="axil-service text-left axil-control paralax-image">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <h4 class="title"><a href="single-service.html">Email marketing</a></h4>
                                            <p>We design professional looking yet simple websites. Our designs are
                                                search engine
                                                and user friendly. </p>
                                            <a class="axil-button" data-hover="Learn More" href="single-service.html">Learn More</a>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="axil-service text-left axil-control paralax-image">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <h4 class="title"><a href="single-service.html">Display marketing</a></h4>
                                            <p>We design professional looking yet simple websites. Our designs are
                                                search engine
                                                and user friendly. </p>
                                            <a class="axil-button" data-hover="Learn More" href="single-service.html">Learn More</a>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="axil-service text-left axil-control paralax-image">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <h4 class="title"><a href="single-service.html">Social media marketing</a></h4>
                                            <p>We design professional looking yet simple websites. Our designs are
                                                search engine
                                                and user friendly. </p>
                                            <a class="axil-button" data-hover="Learn More" href="single-service.html">Learn More</a>
...
<!-- Mirrored from axilthemes.com/demo/template/keystroke/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jan 2021 19:28:28 GMT -->
</html>